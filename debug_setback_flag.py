...
print("=== Debug: Setback flag analysis ===")
...
# The receiver should be rotated, so its x coordinates should vary
if rc_x_variation < 1e-6:
    print("ERROR: Receiver is NOT rotated (x coordinates are constant)")
    print("This suggests the setback preservation logic is not working")
else:
    print("Receiver IS rotated (x coordinates vary)")
    print("This suggests the setback preservation logic is working")
